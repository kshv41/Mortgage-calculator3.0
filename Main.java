...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        printMortgage(principal, interestRateAnnual, period);
        System.out.println();
        printPaymentSchedule(principal, interestRateAnnual, period);
    }

    public static void printPaymentSchedule(int principal, float interestRateAnnual, byte period) {
        System.out.println("PAYMENT SCHEDULE");
        System.out.println("----------------------");
        paymentSchedule(principal, interestRateAnnual, period);
    }

    public static void printMortgage(int principal, float interestRateAnnual, byte period) {
